...
// Log A data structure for an append-only sequence of records,
...
// Append To append a record to the log, you just append to the slice.
...
// Read Gets record available at offset index
